...
class UserService extends BaseService
{
    ...
    {
        $this->with = ['userInfo', 'userApplication'];
        $this->condition = ['id' => 1];
        $this->select = [
            'userInfo' => ['intro', 'like_num', 'follow_num', 'fans_num', 'post_num', 'my_like_num'],
            'userApplication' => ['app_name']
        ];
        return User::with('userInfo:intro,like_num')->where('id', 1)->get()->toArray();
        // return $this->multiTableJoinQueryBuilder()->get()->toArray();
    }
}